...
* **22.03.2021** -- официальное завершение соревнования и подведение итогов. Результаты тестирования на public test достпуны по [ссылке](public test results.csv), на private test – по [ссылке](private test results.csv) .
