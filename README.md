...
* **22.03.2021** -- официальное завершение соревнования и подведение итогов. Результаты тестирования на public test доступны по [ссылке](public_test_results.csv), на private test – по [ссылке](private_test_results.csv) .
